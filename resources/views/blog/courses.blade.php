	   ...
	   <div class="container">
		...
		<div class="col-md-9">
			...
			<table class="table table-borderless">
				...
				<tbody>
				<tr>
					<td rowspan="4" class="level-col-green"><h5>Things</h5></td>
					<td ><div class="grade-row valign-wrapper"><h4>Some Thing</h4></div></td>
				</tr>
				<tr>
					<td ><div class="grade-row valign-wrapper"><h4>Some Thing</h4></div></td>
				</tr>
				...
				<!--New Row Grade -->
				<tr>
					<td rowspan="3" class="level-col-green"><h5>Things</h5></td>
					<td><div class="grade-row valign-wrapper"><h4>Some Thing</h4></div></td>
				</tr>
				<tr>
					<td><div class="grade-row valign-wrapper"><h4>Some Thing</h4></div></td>
				...
				<!--New Row Grade -->
				<tr>
					<td rowspan="6" class="level-col-green"><h5>Things</h5></td>
					<td><div class="grade-row"><h4>Some Thing</h4></div></td>
				</tr>
				<tr>
					<td><div class="grade-row"><h4>Some Thing</h4></div></td>
				</tr>
